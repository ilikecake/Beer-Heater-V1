...
//Setup the CS pin
#define AT45DB321D_CS_PORT	PORTB
#define AT45DB321D_CS_PIN	0

#define USE_LUFA_SPI		1

#if USE_LUFA_SPI == 1
	#define AT45DB321D_SPISEND		SPI_TransferByte
#else
	#define AT45DB321D_SPISEND		SPISendByte
#endif
